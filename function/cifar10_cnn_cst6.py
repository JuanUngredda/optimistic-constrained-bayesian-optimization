...
class Cifar10CNN_CST6(BlackBoxFunction):
    def __init__(
        self,
        xsize=10,
        zsize=10,
        ...
        super(Cifar10CNN_CST6, self).__init__(
            xdim, zdim, xsize, zsize, task_identifier, noise_std=noise_std
        )

        self.module_name = "cifar10_cnn_cst6"
        func_data = Cifar10CNN_CST6.get_objfunc_and_constraints()
