...
class SpeedReducer_CST11(BlackBoxFunction):
    ...
    def get_noiseless_notransformed_observation(self, xz):
        with torch.no_grad():
            ...
            val = bilog(constraint_raw(xz, 11)).reshape(-1)
        return val.float()
