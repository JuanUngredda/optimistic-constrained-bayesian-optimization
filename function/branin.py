...
class Branin(BlackBoxFunction):
    ...
    #     # result: choose 2_1 is difficult than 2_2
    #     #         the difference between 2 modes in 2_1 is only ~0.1
    #     #         so we choose 2_2
    ...
    #             }
    #         else:
    #             raise Exception(f"Branin unknown zdist identifier: {zdist_identifier}")
    #
    ...
    def get_params(self, task_identifier):
        ...
        if zdist_identifier == "original_2_1":
            params = {
                # distribution of z
                "z_distribution": {"mu": 0.1, "sigma": 0.1},
            }
    ...
    def get_noiseless_notransformed_observation(self, xz):
        ...
        with torch.no_grad():
            ...
            xz = 15.0 * xz - torch.tensor([5.0, 0.0])
