...
class WeldedBeamDesign_2_3_5_CST1(BlackBoxFunction):
    ...
    def __init__(
        ...
        super(WeldedBeamDesign_2_3_5_CST1, self).__init__(
            xdim, zdim, xsize, zsize, task_identifier, noise_std=noise_std
        )

        self.module_name = "welded_beam_design_2_3_5_cst1"
        self.xsize = xsize
        self.zsize = zsize
    ...
    def get_noiseless_notransformed_observation(self, xz):
        ...
        with torch.no_grad():
            ...
            print(f"Threshold <= {threshold}") # -0.3215125873389276
