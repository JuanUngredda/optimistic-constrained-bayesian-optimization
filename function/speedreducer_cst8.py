...
class SpeedReducer_CST8(BlackBoxFunction):
    ...
    def get_noiseless_notransformed_observation(self, xz):
        with torch.no_grad():
            ...
            val = bilog(constraint_raw(xz, 8)).reshape(-1)
        return val.float()
