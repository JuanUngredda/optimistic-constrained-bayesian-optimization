...
class Cifar10CNN_CST7(BlackBoxFunction):
    def __init__(
        self,
        xsize=10,
        zsize=10,
        ...
        super(Cifar10CNN_CST7, self).__init__(
            xdim, zdim, xsize, zsize, task_identifier, noise_std=noise_std
        )

        self.module_name = "cifar10_cnn_cst7"
        func_data = Cifar10CNN_CST7.get_objfunc_and_constraints()
